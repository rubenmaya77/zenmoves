...
import com.moviapp.jetpackcomposenewsapp.data.entity.NewsResponse
import com.moviapp.jetpackcomposenewsapp.ui.theme.Purple40
...
fun NewsRowComponentPreview() {
    val film = Film(
        ...
        description = "Two sisters move to the country and discover magical spirits.",
